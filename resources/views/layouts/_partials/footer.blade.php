<section class="subscribe-section pt_45 pb_45">
    ...
    <div class="auto-container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 justify-content-end">
                <ul class="social-links d-flex justify-content-end gap-3">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 footer-column">
                    <div class="footer-widget about-widget">
                        <div class="widget-content">
                            ...
                            <div class="location-box mt-5"><p class="fs-5 text-white"><i class="icon-17"></i>{{ $identities->address }}</p></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="bottom-inner d-flex justify-content-center text-center">
                <div class="copyright d-flex justify-content-center text-center"><p>Copyright 2025 by <a href="index-2.html">Amcare</a> All Right Reserved.</p></div>
            </div>
        </div>
    </div>
</footer>
